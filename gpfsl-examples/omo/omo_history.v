...
From gpfsl.examples.omo Require Import omo_event.
...
Record history_wf E :=
  mkHistoryWf {
    ...
    hwf_logview_event :
      ∀ e eV, E !! e = Some eV → e ∈ eV.(eview) ;
    (* logview is closed w.r.t E *)
    hwf_logview_closed :
      ∀ e eV, E !! e = Some eV → set_Forall (λ e', is_Some (E !! e')) eV.(eview) ;
  }.
...
Lemma history_wf_add_sync E e1 eV1 eV2 M
  ...
  history_wf E'.
Proof.
  have SubM1E : set_Forall (λ e, is_Some (E !! e)) eV1.(eview)
...
Lemma hb_ord_cons_inv E e eV ord
  ...
  « HB_ORD' : hb_ord E ord » ∧
  « NO_REV_HB : Forall (λ e', e' ∉ eV.(eview)) ord » .
Proof.
